...
class oemedical_patient_lab_test(osv.osv):
    ...
    _columns = {
        'name': fields.many2one('oemedical.test_type', 'Test Typeee'),
        'date': fields.datetime('Date'),
        'state': fields.selection([('draft', 'Draft'), ('tested', 'Tested'), ('cancel', 'Cancel')], 'State',
                                  readonly=True),
    ...
    _defaults = {
        ...
        'doctor_id': _get_default_dr,  #'invoice_status': lambda *a: 'tobe',
    }
